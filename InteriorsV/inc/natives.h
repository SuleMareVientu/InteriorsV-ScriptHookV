...
namespace OBJECT
{
	...
	static void DOOR_SYSTEM_SET_AUTOMATIC_RATE(Hash doorHash, float p1, BOOL p2, BOOL p3) { invoke<Void>(0x03C27E13B42A0E82, doorHash, p1, p2, p3); } // 0x03C27E13B42A0E82 0x4F44AF21
	...
	static void DOOR_SYSTEM_SET_HOLD_OPEN(Hash doorHash, BOOL toggle) { invoke<Void>(0xD9B71952F78A2640, doorHash, toggle); } // 0xD9B71952F78A2640 0xECE58AE0
	...
	static BOOL DOOR_SYSTEM_GET_IS_PHYSICS_LOADED(Hash doorHash) { return invoke<BOOL>(0xDF97CDD4FC08FD34, doorHash); } // 0xDF97CDD4FC08FD34 0x17FF9393
	static BOOL DOOR_SYSTEM_FIND_EXISTING_DOOR(float x, float y, float z, Hash modelHash, Hash* outDoorHash) { return invoke<BOOL>(0x589F80B325CC82C5, x, y, z, modelHash, outDoorHash); } // 0x589F80B325CC82C5 0xE9AE494F
